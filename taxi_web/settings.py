"""
Django settings for taksi_web project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'taxi_db'),
        'USER': os.environ.get('POSTGRES_USER', 'postgres'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'postgres'),
        'HOST': os.environ.get('POSTGRES_HOST', 'localhost'),
        'PORT': os.environ.get('POSTGRES_PORT', '5432'),  # compose'da PORT var, onu da oku
        'CONN_MAX_AGE': 60,
...
# ── Celery (heavy ML work runs on the separate `worker` container) ────────────
